...
const questions = [
	...
	{question: "What tastes sound good to you?", choices: ["Matly with a balance of hop bitterness", "Matl accented with hints of caramel","A dark Malt with flavors of caramel and toffee", "Note of Chocolate with mild roast in the finish", "Heavily roasted flavor. Hints of coffee"], lastQuestion: true},//#4 result
	{question: "What are you going to be eating?", choices: ["Chicken, Seafood, Cheeses, and Lemon Flavors","Sweet, Hot or Spicy Foods", "Acidic and Spicy Flavors like Mustard, Pickels and Horseradish", "Spicy, Heat-Charred, Smoky, or Aromic Flaors", "Salty, Spicy, and Fried Foods, Burgers"], lastQuestion: true},//#5 result
...
const askQuestion = whichOne => {
	...
	for(let i = 0; i < questions[whichOne].choices.length; i++){
        ...
        const choiceBTN = $("<button id=choice"+i+"></button>")
